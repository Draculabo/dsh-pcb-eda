...
async function handleDirectFootprint(
  ...
  if (!userQuestions || typeof userQuestions.ask !== 'function') {
    return Object.assign(
      ...
      generated,
      {
        note: 'The service recognised this as a standard package and generated the footprint directly ' +
  ...
  try {
    ...
    return Object.assign(
      ...
      generated,
      {
        note: 'The auto-generated footprint could not be presented for confirmation (' +
  ...
  if (decision.verdict === 'declined') {
    return {
      ...
      note: 'The user declined the auto-generated footprint. Ask for the package_type and dimensions, ' +
